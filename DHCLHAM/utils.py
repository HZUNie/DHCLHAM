...
class Metric_fun(object):
    ...
    def get_metrics(self, real_score, predict_score):
        ...
        # fpr = np.array(x_ROC).flatten()
        # tpr = np.array(y_ROC).flatten()
        ...
        return [auc[0, 0], aupr[0, 0], f1_score, accuracy, recall, specificity, precision, fpr, tpr, recall_list, precision_list]
